...
<div class="container-fluid py-3">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 bg-white p-3 rounded-4 shadow-sm border">
        <div>
            <h4 class="fw-bold text-primary mb-0">
                <i class="fa-solid fa-users-slash me-2"></i> Fee Defaulters Directory
            </h4>
            <p class="text-muted small mb-0">List of students with outstanding dues and unpaid fee balances.</p>
        </div>
        <div>
            <a href="{{ route('fees.index') }}" class="btn btn-outline-primary fw-bold rounded-3">
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-header bg-primary text-white p-3 d-flex justify-content-between align-items-center">
            <span class="fw-bold fs-6"><i class="fa-solid fa-list me-2"></i> Active Fee Defaulters</span>
            <span class="badge bg-white text-primary fw-bold fs-7">{{ count($defaulters ?? []) }} Defaulters Found</span>
        </div>
                    ...
                    <tbody>
                        ...
                        @php
                            $msg = "Dear {$defaulter->admission->student_name},\n"
                                 ...
                                 . "Thank you - EduPortal Management";
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="fw-bold text-dark"><i class="fa-solid fa-phone me-1 text-primary"></i>{{ $defaulter->admission->mobile_number ?? $defaulter->admission->mobile_contact ?? 'N/A' }}</div>
                            </td>
                            ...
                            <td class="text-center pe-3">
                                <div class="d-flex justify-content-center gap-1">
                                    ...
                                    <a href="{{ route('fees.create', $defaulter->admission_id) }}" class="btn btn-primary btn-sm fw-bold shadow-sm">
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-5 text-muted">
                                <i class="fa-solid fa-circle-check fs-2 text-primary d-block mb-2"></i>
